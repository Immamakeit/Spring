...
<div class="con_txt">
	<form action="board_modify1_ok.do" method="post" name="mfrm">
		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view1.do?seq=<%=seq %>'" />
				</div>
